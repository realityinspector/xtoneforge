---
title: Demo Mode
description: Try Stoneforge for free using demo mode — no API keys required.
---
...
<Aside type="tip">
  Demo mode is the fastest way to explore Stoneforge's multi-agent orchestration. You can always switch to a more capable provider later.
</Aside>
