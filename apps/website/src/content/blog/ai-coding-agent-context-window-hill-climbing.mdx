...
## How we do this in Stoneforge

We build [Stoneforge](https://github.com/toolcog/stoneforge), an [open-source AI orchestration platform](/blog/introducing-stoneforge/) where AI agents are first-class contributors. We've been iterating on this documentation architecture for months, and a few things have been particularly high-leverage.
